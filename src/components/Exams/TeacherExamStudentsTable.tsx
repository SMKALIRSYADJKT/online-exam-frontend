...
interface TeacherExamStudentsTableProps {
  data: Submission[];
  searchParams: URLSearchParams;
  setSearchParams: (params: Record<string, string>) => void;
}

const TeacherExamStudentsTable: React.FC<TeacherExamStudentsTableProps> = ({
  data,
  searchParams,
  setSearchParams,
}) => {
  ...
  const handleGrade = (submissionId: string | number) => {
