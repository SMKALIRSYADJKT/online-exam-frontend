...
interface FormData {
  ...
  name: string;
  description: string;
  class_id: string | number | null;  // Add number to the type union
}
...
const Subjects: React.FC = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const res = await api.get<{ data: Subject[]; meta: Meta }>("/subjects", {
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <div>
                        ...
                        <div className="border border-gray-300 rounded-lg">
                            <ClassSelect
                              classes={String(formData.class_id)}
                              setClasses={(value: string | null) => setFormData((prev) => ({ ...prev, class_id: value }))}
                            />
                        </div>
                      </div>
