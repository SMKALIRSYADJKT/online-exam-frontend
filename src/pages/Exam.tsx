...
interface FormData {
  ...
  type: "REGULER" | "REMEDIAL" | null;  // Changed from string to specific union type
  date: string;
  duration: number;
}
                      ...
                      <div>
                        ...
                        <div className="border border-gray-300 rounded-lg">
                          <ExamTypeSelect
                            type={formData.type}
                            setType={(value) =>
                              setFormData((prev) => ({ ...prev, type: value || null }))
                            }
                          />
                        </div>
                      </div>
                        ...
                        <div className="border border-gray-300 rounded-lg">
                          <SubjectSelect
                            ...
                            setSubject={(value) =>
                              setFormData((prev) => ({
                                ...prev,
                                subject_id: value ? String(value) : null,
                              }))
                            }
                          />
                        </div>
